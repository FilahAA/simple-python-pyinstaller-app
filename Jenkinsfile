        ...
        withEnv(['VOLUME="${PWD}/sources:/src"' , 'IMAGE="cdrx/pyinstaller-linux:python2"']) {
            ...
            if (currentBuild.result == null || currentBuild.result == 'SUCCESS') { 
                ...
                sshagent(credentials: ['ubuntu-app-server']) {
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no ubuntu@ec2-54-254-139-194.ap-southeast-1.compute.amazonaws.com "cd python"'
                    sh 'ssh -o StrictHostKeyChecking=no ubuntu@ec2-54-254-139-194.ap-southeast-1.compute.amazonaws.com "sudo chmod a+x add2vals"'
